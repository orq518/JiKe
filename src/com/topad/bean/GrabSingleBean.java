...
public class GrabSingleBean implements Serializable {
    ...
    public void setNeedTName(String needTName) {
        this.needTName = needTName;
    }

    public String getNeedSafemoney() {
        return needSafemoney;
    }

    public void setNeedSafemoney(String needSafemoney) {
        this.needSafemoney = needSafemoney;
    }
    ...
    public void setNeedFinish(String needFinish) {
